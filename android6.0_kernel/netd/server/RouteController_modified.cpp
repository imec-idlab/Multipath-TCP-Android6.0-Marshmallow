...
const uint32_t RULE_PRIORITY_VPN_OVERRIDE_OIF    = 10666;
...
const uint32_t RULE_PRIORITY_DEFAULT_NETWORK     = 22001;
...
const char* const ROUTE_TABLE_NAME_LOCAL_NETWORK  = "local_networkX";
const char* const ROUTE_TABLE_NAME_LEGACY_NETWORK = "legacy_networkX";
const char* const ROUTE_TABLE_NAME_LEGACY_SYSTEM  = "legacy_systemX";

const char* const ROUTE_TABLE_NAME_LOCAL = "localX";
const char* const ROUTE_TABLE_NAME_MAIN  = "mainX";
...
WARN_UNUSED_RESULT int modifyDefaultNetwork(uint16_t action, const char* interface,
    ...
    //modifyIpRule(action, RULE_PRIORITY_DEFAULT_NETWORK+100, table, NULL, NULL);
